...
public class CalendarRepository implements DeleteMeetingRequest.OnResponse, AcceptDeclineMeetingRequest.OnResponse {
    ...
    public CalendarRepository(BaseRequest.RenewTokenFailed renewTokenFailed, Callback callback) {
    ...
    public RealmResults<MeetingRealm> getAllMeetings() {
        return meetingsDb.findAllShownMeetingsAsync();
    }

    public GetUser getUser(int id) {
        return usersDb.findUser(id);
    }
