...
public class CallsActivity extends BaseActivity implements CallsActivityView, View.OnClickListener, CallsWebRTCatManager.CallsCallbacks, AlertConfirmOrCancel.AlertConfirmOrCancelInterface {
    ...
    CallsWebRTCatManager callsManager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("incalock","call activity oncreate");
    ...
    public void finishCallActivity() {
        Log.d("incalock","finish call activity");
        finish();
    }
