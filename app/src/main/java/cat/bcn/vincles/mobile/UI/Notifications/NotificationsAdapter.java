...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.NotificationViewHolder> {
    ...
    public void onBindViewHolder(final NotificationViewHolder holder, int position) {
        ...
        switch (notification.getType()) {
            ...
            case "USER_LINKED":
                setAvatar(holder.avatar, users.get(notification.getIdUser()).getPath());
            ...
            case NotificationsDb.MEETING_REMINDER_NOTIFICATION_TYPE:
                ...
                String photo = notification.getIdUser() == userPreferences.getUserID() ?
                        userPreferences.getUserAvatar() : users.get(notification.getIdUser()).getPath();
                photo = photo.replace("file://","");
                setAvatar(holder.avatar, photo);
            ...
            case "MEETING_DELETED_EVENT":
                ...
                break;
            case "ADDED_TO_GROUP":
                setAvatar(holder.avatar, groups.get(notification.getIdUser()).getPhoto());
                holder.content.setText(holder.content.getResources().getString(
            ...
            case "NEW_CHAT_MESSAGE":
                ...
                dynamizer = userGroupsDb.findDynamizerFromChatId(notification.getIdChat());
    ...
    private void setAvatar(ImageView imageView, String path) {
