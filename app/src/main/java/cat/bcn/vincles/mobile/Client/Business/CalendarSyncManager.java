...
public class CalendarSyncManager {
    ...
    public long addCalendar() {
        ...
        contentValues.put(CalendarContract.Calendars.ACCOUNT_TYPE, "Vincles");
        ...
        uri = uri.buildUpon().appendQueryParameter(android.provider.CalendarContract.CALLER_IS_SYNCADAPTER,"true")
                ...
                .appendQueryParameter(CalendarContract.Calendars.ACCOUNT_TYPE, "Vincles").build();
    ...
    private long getId() {
        ...
        String[] selectionArgs = new String[]{"Vincles", "Vincles", "Vincles"};
    ...
    public void addAllMeetings(long calendarId, RealmResults<MeetingRealm> meetings) {
        ...
        for (MeetingRealm meeting : meetings) {
            ...
            meetingsDb.setMeetingAndroidCalendarId(meeting.getId(), eventId);
        }
    }
    ...
    public String getListOfUsers(List<Integer> userIds) {
        ...
        for (Integer userId : userIds) {
            ...
            if (myId == userId) {
                ...
                GetUser getUser = usersDb.findUser(userId);
                if (getUser != null) usersString.append(getUser.getName() + " " + getUser.getLastname());
            }
        }
