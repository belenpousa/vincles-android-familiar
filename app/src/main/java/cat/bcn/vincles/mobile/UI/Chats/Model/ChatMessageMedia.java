...
public class ChatMessageMedia extends ChatMessage {
    ...
    public ChatMessageMedia(int type, long sendTime, String text, long id, int idUserFrom,
                            boolean watched, ArrayList<String> mediaFiles,
                            String fullNameUserSender, ArrayList<Boolean> isVideo) {
