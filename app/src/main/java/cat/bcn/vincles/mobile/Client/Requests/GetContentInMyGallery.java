...
public class GetContentInMyGallery extends BaseRequest implements Callback<GalleryContent> {
    ...
    public void doRequest(String accessToken) {
        ...
        Call<GalleryContent> call = galleryService.getContentInMyGallery(idContent);
        call.enqueue(this);
    }
    ...
    @Override
    public void onFailure(Call<GalleryContent> call, Throwable t) {
    ...
    public interface OnResponse {
        void onResponseGetContentInMyGallery(GalleryContent galleryContent);
