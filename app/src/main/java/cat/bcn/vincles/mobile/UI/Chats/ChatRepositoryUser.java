...
public class ChatRepositoryUser extends ChatRepository implements
        GetUserMessagesRequest.OnResponse, GetGalleryContentRequest.OnResponseMessage,
    ...
    public ArrayList<GetUser> getUserListData() {
        ...
        GetUser chatUser = usersDb.findUserAsync(chatId);
    ...
    public void getMediaFile(long messageId, int position) {
        ...
        String accessToken = new UserPreferences().getAccessToken();
        GetGalleryContentRequest getGalleryContentRequest = new GetGalleryContentRequest(
                renewTokenListener, MyApplication.getAppContext(), fileId, "");
        getGalleryContentRequest.addOnOnResponse(this);
        getGalleryContentRequest.setMessageID(messageId);
        getGalleryContentRequest.doRequest(accessToken);
    }
    ...
    public void onResponseGetGalleryContentRequest(String contentID, String filePath,
        ...
        //listener.onFileReceived(messageID, filePath);
        onFileReceived(messageID, Integer.parseInt(contentID), filePath, mimeType);

        if (!filePath.endsWith(".aac") && new UserPreferences().getIsCopyPhotos() && ContextCompat.checkSelfPermission(
