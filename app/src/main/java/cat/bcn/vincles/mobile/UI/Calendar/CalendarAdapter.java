...
public class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarViewHolder> {
    ...
    public class CalendarViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void fillInfo(MeetingRealm meetingRealm) {
            ...
            GetUser hostUser = usersList.get(meetingRealm.getHostId());
            ...
            guests.setText(getListOfUsers(meetingRealm.getGuestIDs(), guests.getResources()));
    ...
    public String getListOfUsers(List<Integer> userIds, Resources resources) {
    ...
    public CalendarAdapter(Context context, List<MeetingRealm> elementsList,
                           SparseArray<GetUser> users, OnItemClicked clickListener) {
