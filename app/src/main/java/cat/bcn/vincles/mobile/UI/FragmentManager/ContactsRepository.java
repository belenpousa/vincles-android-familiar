...
public class ContactsRepository implements GetCircleUserRequest.OnResponse, GetUserPhotoRequest.OnResponse,
    ...
    public void deleteCircle(int idUserToUnlink) {
        ...
        GetUser getUser = usersDb.findUser(idUserToUnlink);
        if (getUser != null) {
            String token = new UserPreferences().getAccessToken();
    ...
    public void onResponseGetCircleUserRequest(CircleUsers circleUsers) {
        ...
        usersDb.saveCircleUsers(circleUsers.getCircleUsers());
        loadUserCircles();
    }
    ...
    public void onResponseGetUserCircleRequest(UserCircles userCircles) {
        ...
        usersDb.saveUserCircles(userCircles.getUserCircles());
        loadGroups();
    ...
    public void onResponseGetUserGroupsRequest(UserGroups userGroups) {
        ...
        for (UserGroup userGroup: userGroups.getUserGroups()) {
            ...
            GroupRealm currentGroupRealm = userGroupsDb.getGroup(userGroup.getGroup().getIdGroup());
        ...
        userGroupsDb.saveCurrentUsersGroups(userGroups.getUserGroups());
    ...
    public void shareMediaToOneContact(ArrayList<Integer> mediaIdArrayList, int contactId) {
        ...
        chatMessageRest.setMetadataTipus("MESSAGE_IMAGE");
    ...
    public void shareMediaToManyContacts(ArrayList<Integer> mediaIdArrayList,
                                         ArrayList<Integer> contactIdArrayList,
                                         ArrayList<Integer> contactIdChatArrayList) {
        ArrayList<Integer> idContents = getIdContentArrayFromId(mediaIdArrayList);
        ...
        chatMessageMulticastRest.setMetadataTipus("MESSAGE_IMAGE");
    ...
    private ArrayList<Integer> getIdContentArrayFromId(ArrayList<Integer> idArray) {
        ArrayList<Integer> idContents = new ArrayList<>();
        GalleryDb galleryDb = new GalleryDb(MyApplication.getAppContext());
        for (int id : idArray) {
            idContents.add(galleryDb.getIdContentFromId(id));
        }
        return idContents;
    }
    ...
    public void onResponseExitCircleRequest(int idUserToUnlink, int circleId) {
        ...
        UsersDb usersDb = new UsersDb(MyApplication.getAppContext());
        if (!usersDb.deleteUserCircle(circleId)) {
            usersDb.deleteCircleUser(idUserToUnlink);
        }
