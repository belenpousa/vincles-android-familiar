...
public interface ChatService {
    ...
    public Call<ChatMessageRestList> getUserMessages(@Path("idUserSender") String idUserSender, @QueryMap Map<String, String> params);

    @GET("/t/vincles-bcn.cat/vincles-services/1.0/messages/mine")
    public Call<ChatMessageRestList> getChatMessagesFrom(@QueryMap Map<String, String> params);
    ...
    public Call<GroupMessageRestList> getGroupMessages(@Path("idChat") String idChat, @QueryMap Map<String, String> params);
